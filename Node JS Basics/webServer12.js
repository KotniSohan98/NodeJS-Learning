...
//Emmiting and Handling Custom Events
...
// });
// myEmitter.on("userCreated", () => {
//   console.log("A new user is added in Database!");
// });

// myEmitter.emit("userCreated");

//To pass some values to callback function example
myEmitter.on("userCreated", (id, name) => {
  console.log(`A new user ${name} with ID ${id} is created1`);
});
myEmitter.on("userCreated", (id, name) => {
  console.log(`A new user ${name} with ID ${id} is added in Database!`);
});

myEmitter.emit("userCreated", "101", "Sohan");
